		...
		<div class="container margin_120_95">
			...
			<div class="row">
				<div class="col-lg-8 col-md-8 wow centrer" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							...
							<div class="info">
								<small><i class="ti-layers"></i>4 Leçons</small>
								<h3>Reseaux Informatiques</h3>
                                <button type="button" class="btn btn-primary" id="v1">Voir les cours</button>
							</div>
						</figure>
					</a>
				</div>
				...
				<div class="col-lg-8 col-md-8 wow centrer" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							...
							<div class="info">
								<small><i class="ti-layers"></i>5 Leçons</small>
								<h3>Programmation Orientée Objet</h3>
                                <button type="button" class="btn btn-primary" id="v2" disabled="">Voir les cours</button>   
							</div>
						</figure>
					</a>
				</div>
                <!-- /section -->
						...
						<section class="lesson2" id="lessons">
							<div class="intro_title">
								<h2>Lessons</h2>
								<ul>
									<li>18 lessons</li>
