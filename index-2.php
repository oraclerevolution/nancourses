			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 wow centrer" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="img/images/linux.jpg" width="800" height="533" class="img-fluid" alt="">
							<div class="info">
								<small><i class="ti-layers"></i>2 Programmes</small>
								<h3>Administration Systemes</h3>
							</div>
						</figure>
					</a>
				</div>
				...
				<div class="col-lg-8 col-md-8 wow centrer" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="img/images/logiciels.jpg" height="533" width="800" class="img-fluid" alt="">
							<div class="info">
								<small><i class="ti-layers"></i>23 Programmes</small>
				...
				<div class="col-lg-8 col-md-8 wow centrer" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="img/images/objet.jpg" height="533" width="233" class="img-fluid" alt="">
							<div class="info">
								<small><i class="ti-layers"></i>23 Programmes</small>
								<h3>Programmtion Orientée Objet</h3>
							</div>
						</figure>
					</a>
				</div>
				...
				<div class="col-lg-8 col-md-8 wow centrer" data-wow-offset="150">
					<a href="#0" class="grid_item">
						<figure class="block-reveal">
							<div class="block-horizzontal"></div>
							<img src="img/images/mobile.jpg" height="533" width="345" class="img-fluid" alt="">
							<div class="info">
								<small><i class="ti-layers"></i>23 Programmes</small>
								<h3>Programmation Mobile</h3>
							</div>
						</figure>
					</a>
				</div>
